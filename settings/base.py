...
INSTALLED_APPS = [
    ...
    'django.contrib.messages', 'django.contrib.staticfiles', 'productsapp',
    "pwa"
]
...
PWA_APP_NAME = 'Serving Serpent'
PWA_APP_DESCRIPTION = "Serving serpent is a web application that allows you to manage your Commerce"
